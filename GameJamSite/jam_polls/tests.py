...
class PollViewTest(TestCase):
    def setUp(self):
        ...
        self.question1 = Poll.objects.create(question_text='Question 1', jam_uuid=self.jam_case_1)
        self.question2 = Poll.objects.create(question_text='Question 2', jam_uuid=self.jam_case_1)
    ...
    def test_poll_list(self):
        ...
        self.assertContains(response, Poll.objects.get(id=1).question_text)
